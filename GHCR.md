...
1. Set Coolify env var (optional): `OPENCLAW_IMAGE=ghcr.io/marcoby-dev-ops/openclaw-coolify:2026.2.24`
...
Notes
-----
- The provided `docker-compose.ghcr.yaml` mirrors the service config but uses an image reference for `openclaw` (defaults to `:2026.2.24`).
